...
with role_permissions(role_name, module_name, can_preview, can_create, can_edit, can_delete, can_export, can_import, can_manage) as (
  values
    ...
    ('speaker_coordinator', 'calendar_events', true, false, false, false, false, false, false),
    ('speaker_coordinator', 'sunday_school_classes', true, false, false, false, false, false, false),
    ('speaker_coordinator', 'service_assignments', true, false, false, false, false, false, false),
    ('speaker_coordinator', 'bulletins', true, false, false, false, false, false, false),
    ...
    ('speaker_coordinator', 'search', true, false, false, false, false, false, false),

    ('service_scheduler', 'calendar_events', true, false, false, false, false, false, false),
    ('service_scheduler', 'sunday_school_classes', true, false, false, false, false, false, false),
    ('service_scheduler', 'speaker_assignments', true, false, false, false, false, false, false),
    ('service_scheduler', 'bulletins', true, false, false, false, false, false, false),
    ...
    ('service_scheduler', 'search', true, false, false, false, false, false, false),

    ('bulletin_editor', 'calendar_events', true, false, false, false, false, false, false),
    ('bulletin_editor', 'sunday_school_classes', true, false, false, false, false, false, false),
    ('bulletin_editor', 'speaker_assignments', true, false, false, false, false, false, false),
    ('bulletin_editor', 'service_assignments', true, false, false, false, false, false, false),
    ('bulletin_editor', 'bulletins', true, true, true, false, true, false, false),
    ('bulletin_editor', 'search', true, false, false, false, false, false, false),
